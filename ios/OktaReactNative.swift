...
@objc(OktaReactNative)
class OktaReactNative: RCTEventEmitter {
    ...
    @objc
    func createConfig(_ options:[String: Any],
                      successCallback: RCTResponseSenderBlock,
                      errorCallback: RCTResponseSenderBlock) {
        do {
            let userAgentTemplate = options["userAgentTemplate"] as! String
            let discoveryUri = options["discoveryUri"] as! String
            let clientId = options["clientId"] as! String
            let redirectUrl = options["redirectUri"] as! String
            let endSessionRedirectUri = options["endSessionRedirectUri"] as! String
            let scopes = options["scopes"] as! Array<String>
            let timeouts = options["timeouts"] as! [String: Int]
            ...
            self.requestTimeout = timeouts["httpConnectionTimeout"]
...
extension OktaReactNative: OktaNetworkRequestCustomizationDelegate {
