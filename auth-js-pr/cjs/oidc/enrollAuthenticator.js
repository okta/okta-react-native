...
function enrollAuthenticator(sdk, options) {
  ...
  const params = (0, _util2.prepareEnrollAuthenticatorParams)(sdk, options);
  const meta = (0, _util2.createEnrollAuthenticatorMeta)(sdk, params);
  const requestUrl = meta.urls.authorizeUrl + (0, _authorize.buildAuthorizeParams)(params);
